...
def random_music(dominant_emotion):
    try:
        ...
        emotion_folder_map = {
            'happy': 'music_folder/happy',  # 替換為實際的資料夾路徑
            'sad': 'music_folder/sad',
            'angry': 'music_folder/angry'
        }
    ...
    for (x, y, w, h) in faces:
        ...
        if emotion in emotion_counts:
            ...
            if emotion_counts[emotion] >= emotion_threshold:
                ...
                frame = put_chinese_text(frame, text, (x, y - 30), "NotoSansTC-VariableFont_wght.ttf", 24, (160, 32, 240))
